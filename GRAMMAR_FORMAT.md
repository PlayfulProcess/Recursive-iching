> **Copied into this starter so a fork is self-contained.** The authoritative version
> lives in the parent project (recursive-tarot `GRAMMAR_FORMAT.md`); if they drift, that one wins.
